 ...
 * </p>
 * <ul>
 *   <li>{@link ClassDiagram.impl.PackageImpl#getEvent <em>Event</em>}</li>
 *   <li>{@link ClassDiagram.impl.PackageImpl#getCode <em>Code</em>}</li>
 *   <li>{@link ClassDiagram.impl.PackageImpl#getItem <em>Item</em>}</li>
 * </ul>
 *
 * @generated
 */
public class PackageImpl extends MinimalEObjectImpl.Container implements ClassDiagram.Package {
	/**
	...
	public void setCode(String newCode) {
		...
		if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET, ClassDiagramPackage.PACKAGE__CODE, oldCode, code));
	}
