 ...
 * </p>
 * <ul>
 *   <li>{@link ClassDiagram.impl.AccountImpl#getPermission <em>Permission</em>}</li>
...
public class AccountImpl extends MinimalEObjectImpl.Container implements Account {
	...
	public EList getPermission() {
		if (permission == null) {
			permission = new EDataTypeUniqueEList(Permission.class, this, ClassDiagramPackage.ACCOUNT__PERMISSION);
		}
		return permission;
	}
	...
	public Object eGet(int featureID, boolean resolve, boolean coreType) {
		switch (featureID) {
			case ClassDiagramPackage.ACCOUNT__PERMISSION:
	...
	public void eSet(int featureID, Object newValue) {
		switch (featureID) {
			case ClassDiagramPackage.ACCOUNT__PERMISSION:
				getPermission().clear();
				getPermission().addAll((Collection)newValue);
				return;
			case ClassDiagramPackage.ACCOUNT__USERNAME:
